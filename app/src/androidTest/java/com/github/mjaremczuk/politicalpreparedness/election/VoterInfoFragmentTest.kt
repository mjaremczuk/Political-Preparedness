...
class VoterInfoFragmentTest : BaseFragmentTest() {
    ...
    fun loadDetails_FailedShowVoterDetailsUpcomingElection() = runBlockingTest {
        ...
        onView(withId(R.id.state_header)).check(matches(not(isDisplayed())))
        onView(withId(R.id.state_ballot)).check(matches(not(isDisplayed())))
        onView(withId(R.id.state_locations)).check(matches(not(isDisplayed())))
        onView(withId(R.id.state_correspondence_header)).check(matches(not(isDisplayed())))
